...
class DQNAgent:
    ...
    def make_model(self):
        ...
        model.add(layers.Dense(units=24, activation=activations.relu, input_dim=self.state_size, name='dense_1'))
        model.add(layers.Dense(units=24, activation=activations.relu, name='dense_2'))
        model.add(layers.Dense(units=self.action_size, activation=activations.linear, name='dense_3'))
