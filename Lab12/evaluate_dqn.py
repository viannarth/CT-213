...
if os.path.exists('./Lab12/mountain_car.h5'):
    print('Loading weights from previous learning session.')
    agent.load("./Lab12/mountain_car.h5")
else:
...
plt.xlabel('Episode')
plt.ylabel('Return')
plt.savefig('./Lab12/dqn_evaluation.' + fig_format)
...
plt.savefig('./Lab12/agent_decision.' + fig_format)
plt.show()
